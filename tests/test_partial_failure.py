...
def _partial_dict(sha: str) -> dict:
    ...
    return {
        ...
        "functions": [
            {
                "address": "0x401000", "name": "good_fn",
                "signature": "void good_fn(void)", "calling_convention": "cdecl",
                "size_bytes": 16, "is_thunk": False,
                "basic_blocks": [], "cfg": {"nodes": [], "edges": []},
                "callers": [], "callees": [],
                "assembly": "push rbp\nmov rbp,rsp\nret",
                "pseudocode": "void good_fn(void) {}",
                "pseudocode_error": None, "decompiler": "ghidra",
                "stack_frame": {"size": 16, "locals": []},
            },
            {
                "address": "0x401100", "name": "bad_fn",
                "signature": "undefined bad_fn(void)", "calling_convention": "unknown",
                "size_bytes": 4, "is_thunk": False,
                "basic_blocks": [], "cfg": {"nodes": [], "edges": []},
                "callers": [], "callees": [], "assembly": "",
                "pseudocode": None,
